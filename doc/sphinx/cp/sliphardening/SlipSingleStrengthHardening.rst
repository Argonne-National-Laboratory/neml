...
This object further degenerates the general SlipSingleHardening model to where the (single) slip system strength is equal to a single internal variable, defined by a scalar rate equation.
...
The remaining interface must provide the evolution equation, as associated partial derivatives, of the scalar history variable:
