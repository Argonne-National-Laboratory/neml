...
if __name__ == "__main__":
  ...
  res = drivers.uniaxial_test(pmodel, erate = erate, emax = emax,
  ...
  plt.plot(res['strain'], res['stress'], 'g-', label = 'Engineering stress-strain')  
  plt.plot(true_strain, true_stress, 'g--', label = 'True stress-strain')
