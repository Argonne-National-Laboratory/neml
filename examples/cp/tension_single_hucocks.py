...
if __name__ == "__main__":
  ...
  strengthmodel = slipharden.HuCocksHardening(ts, b, t0, 10.0, 0.1, 0.1,0.1)
  slipmodel = sliprules.HuCocksSlipRule(strengthmodel, g0, n)
  ...
  plt.plot(np.array(e)*100, s,label='Hu Cocks model')
  plt.xlabel('Strain (%)')
